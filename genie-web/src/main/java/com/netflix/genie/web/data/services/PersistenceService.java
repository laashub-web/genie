...
public interface PersistenceService {
     ...
     *
     * @param id         The id of the cluster to add the command file to. Not null/empty/blank.
     * @param commandIds The ids of the commands to add. Not null/empty. Must Exist.
     * @throws GenieException If no cluster with the given id exists. Or any of the commands don't exist
     * @deprecated To be removed after V4 resource model migration
     */
    @Deprecated
     ...
     */
    @Deprecated
    void setCommandsForCluster(@NotBlank String id, @NotNull List<String> commandIds) throws GenieException;
     ...
     */
    @Deprecated
    void removeAllCommandsForCluster(@NotBlank String id) throws GenieException;
     ...
     */
    @Deprecated
    void removeCommandForCluster(@NotBlank String id, @NotBlank String cmdId) throws GenieException;
